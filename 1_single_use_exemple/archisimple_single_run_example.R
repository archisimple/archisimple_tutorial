...
library(tidyverse)
library(data.table)
setwd("~/Dropbox/science/projects/archisimple/archisimple_tutorial/1_single_use_exemple/")
source("src/io_archisimple.R")


### 1 . Read the parameter file

params <- read_archisimple_xml("parameter.xml")
...
write_archisimple_XML(params, path = "src/archisimple93/parameter.xml")
...
rs <- fread("src/archisimple93/myroot.txt", header = T)
